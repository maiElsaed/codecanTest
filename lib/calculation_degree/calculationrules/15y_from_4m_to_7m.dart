...
class Model15y4m_15y7m{
  ...
  static int CalculateSumOfVerbal(){
    int SumOfVerbal=0;
    SumOfVerbal+=weigheddegrees15y4m_15y7m.understand(CalculationFromTester.understandDegree);
    // print("SumOfVerbal${SumOfVerbal}");
    SumOfVerbal+=weigheddegrees15y4m_15y7m.information(CalculationFromTester.InformationDegree);
    // print("SumOfVerbal${SumOfVerbal}");
    SumOfVerbal+=weigheddegrees15y4m_15y7m.calculation(CalculationFromTester.CalculationDegree);
    //  print("SumOfVerbal${SumOfVerbal}");
    SumOfVerbal+=weigheddegrees15y4m_15y7m.similarity(CalculationFromTester.SimilarDegree);
    //  print("SumOfVerbal${SumOfVerbal}");
    SumOfVerbal+=weigheddegrees15y4m_15y7m.vocublary(CalculationFromTester.VocublaryDegree);
    //  print("SumOfVerbal${SumOfVerbal}");
    SumOfVerbal+=weigheddegrees15y4m_15y7m.repeatnumber(CalculationFromApp.RepeatNumber);
    // print("SumOfVerbal${SumOfVerbal}");
  ...
  static int CalculateSumOfpractical(){
    ...
    SumOfPractical+=weigheddegrees15y4m_15y7m.picturecomplete(CalculationFromTester.PictureComplete);
    print("SumOfPractical${SumOfPractical}");
    SumOfPractical+=weigheddegrees15y4m_15y7m.objectassrmbly(CalculationFromTester.PictureComplete);
    print("SumOfPractical${SumOfPractical}");
    SumOfPractical+=weigheddegrees15y4m_15y7m.blockdesign(CalculationFromTester.BlockDesign);
    print("SumOfPractical${SumOfPractical}");
    SumOfPractical+=weigheddegrees15y4m_15y7m.maze(CalculationFromTester.Maze);
    print("SumOfPractical${SumOfPractical}");
    // print("SumOfPractical${SumOfPractical}");
