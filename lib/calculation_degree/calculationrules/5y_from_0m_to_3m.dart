...
class Model5y0m_5y3m{
  ...
  static int CalculateSumOfVerbal(){
    int SumOfVerbal=0;
    SumOfVerbal+=Weighteddegrees5y0m_5y3m.understand(CalculationFromTester.understandDegree);
   // print("SumOfVerbal${SumOfVerbal}");
    SumOfVerbal+=Weighteddegrees5y0m_5y3m.information(CalculationFromTester.InformationDegree);
   // print("SumOfVerbal${SumOfVerbal}");
    SumOfVerbal+=Weighteddegrees5y0m_5y3m.calculation(CalculationFromTester.CalculationDegree);
  //  print("SumOfVerbal${SumOfVerbal}");
    SumOfVerbal+=Weighteddegrees5y0m_5y3m.similarity(CalculationFromTester.SimilarDegree);
  //  print("SumOfVerbal${SumOfVerbal}");
    SumOfVerbal+=Weighteddegrees5y0m_5y3m.vocublary(CalculationFromTester.VocublaryDegree);
  //  print("SumOfVerbal${SumOfVerbal}");
    SumOfVerbal+=Weighteddegrees5y0m_5y3m.repeatnumber(CalculationFromApp.RepeatNumber);
   // print("SumOfVerbal${SumOfVerbal}");
  ...
  static int CalculateSumOfpractical(){
     ...
     SumOfPractical+=Weighteddegrees5y0m_5y3m.picturecomplete(CalculationFromTester.PictureComplete);
     print("SumOfPractical${SumOfPractical}");
     SumOfPractical+=Weighteddegrees5y0m_5y3m.objectassrmbly(CalculationFromTester.PictureComplete);
     print("SumOfPractical${SumOfPractical}");
     SumOfPractical+=Weighteddegrees5y0m_5y3m.blockdesign(CalculationFromTester.BlockDesign);
     print("SumOfPractical${SumOfPractical}");
     SumOfPractical+=Weighteddegrees5y0m_5y3m.maze(CalculationFromTester.Maze);
     print("SumOfPractical${SumOfPractical}");
    // print("SumOfPractical${SumOfPractical}");
