...
class Model5y8m_5y11m{
  ...
  static int CalculateSumOfVerbal(){
    int SumOfVerbal=0;
    SumOfVerbal+=Weigheddegrees5y8m_5y11m.understand(CalculationFromTester.understandDegree);
    // print("SumOfVerbal${SumOfVerbal}");
    SumOfVerbal+=Weigheddegrees5y8m_5y11m.information(CalculationFromTester.InformationDegree);
    // print("SumOfVerbal${SumOfVerbal}");
    SumOfVerbal+=Weigheddegrees5y8m_5y11m.calculation(CalculationFromTester.CalculationDegree);
    //  print("SumOfVerbal${SumOfVerbal}");
    SumOfVerbal+=Weigheddegrees5y8m_5y11m.similarity(CalculationFromTester.SimilarDegree);
    //  print("SumOfVerbal${SumOfVerbal}");
    SumOfVerbal+=Weigheddegrees5y8m_5y11m.vocublary(CalculationFromTester.VocublaryDegree);
    //  print("SumOfVerbal${SumOfVerbal}");
    SumOfVerbal+=Weigheddegrees5y8m_5y11m.repeatnumber(CalculationFromApp.RepeatNumber);
    // print("SumOfVerbal${SumOfVerbal}");
  ...
  static int CalculateSumOfpractical(){
    ...
    SumOfPractical+=Weigheddegrees5y8m_5y11m.picturecomplete(CalculationFromTester.PictureComplete);
    print("SumOfPractical${SumOfPractical}");
    SumOfPractical+=Weigheddegrees5y8m_5y11m.objectassrmbly(CalculationFromTester.PictureComplete);
    print("SumOfPractical${SumOfPractical}");
    SumOfPractical+=Weigheddegrees5y8m_5y11m.blockdesign(CalculationFromTester.BlockDesign);
    print("SumOfPractical${SumOfPractical}");
    SumOfPractical+=Weigheddegrees5y8m_5y11m.maze(CalculationFromTester.Maze);
    print("SumOfPractical${SumOfPractical}");
    // print("SumOfPractical${SumOfPractical}");
