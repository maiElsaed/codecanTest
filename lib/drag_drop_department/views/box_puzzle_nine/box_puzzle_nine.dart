...
import 'package:codecansecond/drag_drop_department/views/box_puzzle_ten/box_puzzle_ten.dart';
          ...
          children: [
            ...
            GestureDetector(
              onTap: () {
                ...
                print("box 9${CalculationFromApp.BlockDesign}");
                _timer?.cancel();
