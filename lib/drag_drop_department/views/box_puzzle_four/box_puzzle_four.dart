...
import 'package:codecansecond/drag_drop_department/views/box_puzzle_five/box_puzzle_five.dart';
          ...
          children: [
            ...
            GestureDetector(
              onTap: () {
                ...
                print("box 4${CalculationFromApp.BlockDesign}");
                _timer?.cancel();
