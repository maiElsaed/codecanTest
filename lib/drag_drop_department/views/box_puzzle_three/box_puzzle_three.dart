...
import 'package:codecansecond/drag_drop_department/views/box_puzzle_four/box_puzzle_four.dart';
            ...
            GestureDetector(
                onTap: () {
                  if (checked.contains(false)) {
                    ...
                    print("box 3${CalculationFromApp.BlockDesign}");
                    _timer?.cancel();
                    Navigator.pushReplacement(
                      context,
                      MaterialPageRoute(
