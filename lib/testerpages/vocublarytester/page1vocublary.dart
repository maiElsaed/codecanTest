...
import 'package:codecansecond/testerpages/vocublarytester/page2vocublary.dart';

class  VocublaryTester1Class extends StatefulWidget {
  State<VocublaryTester1Class> createState() => _pg();
}
class _pg extends State<VocublaryTester1Class> {
        ...
        children: [
          ...
          GestureDetector(
            onTap: ()async{
              ...
              print(CalculationFromTester.VocublaryDegree);
              if (check == true) {
