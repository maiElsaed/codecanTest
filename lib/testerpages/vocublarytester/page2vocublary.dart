...
import 'package:codecansecond/testerpages/app_degress/assembleobject_degree_tester.dart';

import '../repeat_tester/repeat_tester1.dart';
//import 'package:codecansecond/logicoperation/voice.dart';
class  VocublaryTester2Class extends StatefulWidget {
  State<VocublaryTester2Class> createState() => _pg();
}
class _pg extends State<VocublaryTester2Class> {
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          GestureDetector(
            onTap: ()async{
              CalculationFromTester.VocublaryDegree += Questiondegree;
