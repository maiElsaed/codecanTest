...
import 'appreciation_block.dart';
import 'appreciation_repeat_number.dart';
import 'departments_degre.dart';
class EvaluationObjectAssemble extends StatefulWidget{
  State<EvaluationObjectAssemble> createState() => _pg();
}
class _pg extends State<EvaluationObjectAssemble> {
            ...
            child: Container(
                ...
                decoration: BoxDecoration(
                  image: DecorationImage(
                    fit: BoxFit.fill,
                    image: AssetImage('images/evaluation_assemble_things.jpg',),
                  ),
                ),
                child: Center(
                  child: Column(
                      children: [
                        ...
                        Container(
                          ...
                          child: Center(
                            child: Text(
                              "${DepartmentDegree.objectassemble()}",
