...
class EvaluationVocublary extends StatefulWidget{
  State<EvaluationVocublary> createState() => _pg();
}
class _pg extends State<EvaluationVocublary> {
            ...
            child: Container(
                ...
                decoration: BoxDecoration(
                  image: DecorationImage(
                    fit: BoxFit.fill,
                    image: AssetImage('images/evaluation_vocublary.jpg',),
                  ),
                ),
                child: Center(
                  child: Column(
