...
import 'appreciation_vocublary.dart';
import 'departments_degre.dart';
class EvaluationSimilar extends StatefulWidget{
  State<EvaluationSimilar> createState() => _pg();
}
class _pg extends State<EvaluationSimilar> {
            ...
            child: Container(
                ...
                decoration: BoxDecoration(
                  image: DecorationImage(
                    fit: BoxFit.fill,
                    image: AssetImage('images/evaluation_similar.jpg',),
                  ),
                ),
                child: Center(
                  child: Column(
