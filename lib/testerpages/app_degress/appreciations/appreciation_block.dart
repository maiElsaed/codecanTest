...
import 'maze.dart';
class EvaluationBlock extends StatefulWidget{
  State<EvaluationBlock> createState() => _pg();
}
class _pg extends State<EvaluationBlock> {
            ...
            child: Container(
                ...
                decoration: BoxDecoration(
                  image: DecorationImage(
                    fit: BoxFit.fill,
                    image: AssetImage('images/evaluation_blokimages.jpg',),
                  ),
                ),
                child: Center(
                  child: Column(
