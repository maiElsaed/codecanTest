...
import 'appreciation_picture_complete.dart';
import 'departments_degre.dart';
class EvaluationRepeat extends StatefulWidget{
  State<EvaluationRepeat> createState() => _pg();
}
class _pg extends State<EvaluationRepeat> {
            ...
            child: Container(
                ...
                decoration: BoxDecoration(
                  image: DecorationImage(
                    fit: BoxFit.fill,
                    image: AssetImage('images/evaluation_repeatnumber.jpg',),
                  ),
                ),
                child: Center(
                  child: Column(
                        ...
                        GestureDetector(
                          onTap: (){
                            Navigator.of(context).push(MaterialPageRoute(builder:
                                (context) {
                              return EvaluationPictureComplete();
                            },
                            ));
                          },
                          child: Container(
