...
class EvaluationMaze extends StatefulWidget{
  State<EvaluationMaze> createState() => _pg();
}
class _pg extends State<EvaluationMaze> {
            ...
            child: Container(
                ...
                decoration: BoxDecoration(
                  image: DecorationImage(
                    fit: BoxFit.fill,
                    image: AssetImage('images/evaluation_maze.jpg',),
                  ),
                ),
                child: Center(
                  child: Column(
