...
import 'appreciation_similar.dart';
import 'departments_degre.dart';
class EvaluationICalculation extends StatefulWidget{
  State<EvaluationICalculation> createState() => _pg();
}
class _pg extends State<EvaluationICalculation> {
            ...
            child: Container(
                ...
                decoration: BoxDecoration(
                  image: DecorationImage(
                    fit: BoxFit.fill,
                    image: AssetImage('images/evaluation_calculation.jpg',),
                  ),
                ),
                child: Center(
                  child: Column(
