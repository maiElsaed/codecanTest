...
import 'appreciation_object_assemble.dart';
import 'appreciation_repeat_number.dart';
import 'departments_degre.dart';
class EvaluationPictureComplete extends StatefulWidget{
  State<EvaluationPictureComplete> createState() => _pg();
}
class _pg extends State<EvaluationPictureComplete> {
            ...
            child: Container(
                ...
                decoration: BoxDecoration(
                  image: DecorationImage(
                    fit: BoxFit.fill,
                    image: AssetImage('images/evaluation_imagecomplete.jpg',),
                  ),
                ),
                child: Center(
                  child: Column(
                      children: [
                        ...
                        Container(
                          ...
                          child: Center(
                            child: Text(
                              "${DepartmentDegree.picturecomplete()}",
                        ...
                        GestureDetector(
                          onTap: (){
                            Navigator.of(context).push(MaterialPageRoute(builder:
                                (context) {
                              return EvaluationObjectAssemble();
                            },
                            ));
                          },
                          child: Container(
