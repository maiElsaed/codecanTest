...
import 'appreciation_information.dart';
import 'departments_degre.dart';

class EvaluationUnderstand extends StatefulWidget{
  State<EvaluationUnderstand> createState() => _pg();
}
class _pg extends State<EvaluationUnderstand> {
            ...
            child: Container(
                ...
                decoration: BoxDecoration(
                  image: DecorationImage(
                    fit: BoxFit.fill,
                    image: AssetImage('images/evaluation_understand.jpg',),
                  ),
                ),
                child: Center(
                  child: Column(
