...
import 'opposite_repeate_tester.dart';
class TesterRepeatDegree extends StatefulWidget {
  State<TesterRepeatDegree> createState() => _pg();
}
class _pg extends State<TesterRepeatDegree> {
  String check = "";
  int degree = 0;
  bool flag = false;
                ...
                onTap: () {
                  if (flag == true) {
                    ...
                    Navigator.of(context).push(
                      MaterialPageRoute(
                        builder: (context) {
                          return TesterOppositeRepeatDegree();
                        },
                      ),
                    );
                  } else {
