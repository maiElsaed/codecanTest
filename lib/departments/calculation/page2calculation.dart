...
class Calculation2Class extends StatefulWidget{
  State<Calculation2Class>createState()=> _pg();
}
class _pg extends State<Calculation2Class> {
  Reader obg=Reader();
  SqlDb sql= SqlDb();
  late List<Map> question;
  static int counters=14;
  static int imageCounter=0;
  static late int grade;
  static late String answer;
  static var questionDisplay="إذا كان سعر 3 كراسات هو جنيه واحد، فكم يكون سعر 24 كراسة";
