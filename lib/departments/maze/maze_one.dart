...
class MazeScreenOne extends StatefulWidget {
  const MazeScreenOne({super.key});

  @override
  State<MazeScreenOne> createState() => _MazeScreenOneState();
}

class _MazeScreenOneState extends State<MazeScreenOne> {
  int _minute = 00;
  int _second=0;
  int _counter=0;
  Timer? _timer;
