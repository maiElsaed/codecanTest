...
import 'maze_five.dart';
import 'dart:async';
class MazeScreenFour extends StatefulWidget {
  const MazeScreenFour({super.key});

  @override
  State<MazeScreenFour> createState() => _MazeScreenState();
}

class _MazeScreenState extends State<MazeScreenFour> {
  int _minute = 00;
  int _second=0;
  int _counter=0;
  Timer? _timer;
            ...
            children: [
              ...
              GestureDetector(
                onTap: (){
                  ...
                  print("maze 4 ${CalculationFromApp.Maze}");
                  //_timer?.cancel();
                  Navigator.of(context).push(MaterialPageRoute(builder: (context) {
                    return MazeScreenFive();
                  },));
                },
                child: Container(
