...
class MazeScreenB extends StatefulWidget {
  const MazeScreenB({super.key});

  @override
  State<MazeScreenB> createState() => _MazeScreenOneState();
}

class _MazeScreenOneState extends State<MazeScreenB> {
  int _minute = 00;
  int _second=0;
  int _counter=0;
  Timer? _timer;
              ...
              GestureDetector(
                onTap: () {
                  if(flag==true){
                    ...
                    setState(() {
                      checking.chech=false;
                    });
                  }
                  if(CalculationFromApp.Maze==4){
                    //_timer?.cancel();
