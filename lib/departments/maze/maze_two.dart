import 'package:codecansecond/departments/maze/maze_three.dart';
import 'package:flutter/material.dart';
import 'package:maze/maze.dart';
import 'package:codecansecond/logicoperation/childdegreefromapps.dart';
import 'maze_two.dart';
import 'dart:async';
class MazeScreenTow extends StatefulWidget {
  const MazeScreenTow({super.key});

  @override
  State<MazeScreenTow> createState() => _MazeScreenOneState();
}

class _MazeScreenOneState extends State<MazeScreenTow> {
  int _minute = 00;
  int _second=0;
  int _counter=0;
  Timer? _timer;
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  ...
                  print("maze 2 ${CalculationFromApp.Maze}");
                  _timer?.cancel();
                  Navigator.of(context).push(
                    MaterialPageRoute(
                      builder: (context) {
                        return MazeScreenThree();
                      },
                    ),
                 );
                },
