...
import 'opposte_repeat_number.dart';
import '../picturecomplete/firstPage.dart';
class RepeatNumberSecond extends StatefulWidget{
  State<RepeatNumberSecond>createState()=> _pg();
}
class _pg extends State<RepeatNumberSecond> {
  Reader obg = Reader();
  SqlDb sql= SqlDb();
